...
`tap-grafana` is a Singer tap for Grafana.
...
```bash
pipx install tap-grafana
```

Install from GitHub:

```bash
pipx install git+https://github.com/ORG_NAME/tap-grafana.git@main
```
...
```
tap-grafana --about --format=markdown
```
-->
